...
CONVERSATION = [
    ("alice", "hey bucket, what's up"),
    ("bob", "cheese is the best food in the world"),
    ("alice", "no, pizza is the best food in the world"),
    ("bob", "gives bucket a rusty hammer"),
    ("alice", "what do you think about cheese"),
    ("bob", "all work and no play makes jack a dull boy"),
    ("alice", "all work and no play makes jack a dull boy"),
    ("bob", "all work and no play makes jack a dull boy"),
    ("alice", "a hammer is for hitting things you disagree with"),
    ("bob", "bucket, tell me about pizza"),
    ("alice", "i think the internet was a mistake"),
    ("bob", "hands bucket a small glass owl"),
]
...
def main() -> int:
    ...
    for author, line in CONVERSATION:
        reply = bot.handle(line, author=author, chat="test", is_private=True)
        print(f"  {author}: {line}")
