...
class BucketDiscordClient(discord.Client if discord else object):
    ...
    async def on_message(self, message) -> None:
        ...
        # This key is used only for short-lived in-memory context and pacing; it
        # is never written to the database or returned by the bot.
    ...
    # ------------------------------------------------------------------
    async def handle_command(self, message, text: str) -> bool:
